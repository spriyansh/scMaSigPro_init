...
#
#   # Extract sol
#   gcoeff2 <- showGroupCoeff(test.scmp.2, view = F, return = T)
#   gcoeff3 <- showGroupCoeff(test.scmp.3, view = F, return = T)
#   gcoeff4 <- showGroupCoeff(test.scmp.4, view = F, return = T)
#
#
#   # Check
#   # Poly-order-2
#   expect_equal(
#     expected = tstep2$group.coeffs,
#     object = gcoeff2
#   )
#   # Poly-order-3
#   expect_equal(
#     expected = tstep3$group.coeffs,
#     object = gcoeff3
#   )
#   # Poly-order-4
#   expect_equal(
#     expected = tstep4$group.coeffs,
#     object = gcoeff4
#   )
# })
