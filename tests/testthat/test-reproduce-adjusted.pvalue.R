...
#
#   # Matric Convert
#   names(test.scmp.2@scPVector@p.adjusted) <- NULL
#   names(test.scmp.3@scPVector@p.adjusted) <- NULL
#   names(test.scmp.4@scPVector@p.adjusted) <- NULL
#
#   # Check
#   # Poly-order-2
#   expect_equal(
#     expected = fit2$p.adjusted,
#     object = test.scmp.2@scPVector@p.adjusted
#   )
#   # Poly-order-3
#   expect_equal(
#     expected = fit3$p.adjusted,
#     object = test.scmp.3@scPVector@p.adjusted
#   )
#   # Poly-order-4
#   expect_equal(
#     expected = fit4$p.adjusted,
#     object = test.scmp.4@scPVector@p.adjusted
#   )
# })
