...
#
#   # Extract sol
#   influ2 <- showInflu(test.scmp.2, view = F, return = T)
#   influ3 <- showInflu(test.scmp.3, view = F, return = T)
#   influ4 <- showInflu(test.scmp.4, view = F, return = T)
#
#
#   # Check
#   # Poly-order-2
#   expect_equal(
#     expected = tstep2$influ.info,
#     object = influ2
#   )
#   # Poly-order-3
#   expect_equal(
#     expected = tstep3$influ.info,
#     object = influ3
#   )
#   # Poly-order-4
#   expect_equal(
#     expected = tstep4$influ.info,
#     object = influ4
#   )
# })
