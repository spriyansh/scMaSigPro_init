...
#
#   # Extract All
#   sigs2 <- get.siggenes(tstep2, rsq = 0.6, vars = "groups")
#   sigs3 <- get.siggenes(tstep3, rsq = 0.6, vars = "groups")
#   sigs4 <- get.siggenes(tstep4, rsq = 0.6, vars = "groups")
#
...
#
#   # Extract sigs
#   test.scmp.2 <- sc.get.siggenes(test.scmp.2, rsq = 0.6, vars = "groups", use_Influ = T)
#   test.scmp.3 <- sc.get.siggenes(test.scmp.3, rsq = 0.6, vars = "groups", use_Influ = T)
#   test.scmp.4 <- sc.get.siggenes(test.scmp.4, rsq = 0.6, vars = "groups", use_Influ = T)
#
#   # Check
#   # Poly-order-2
#   expect_equal(
