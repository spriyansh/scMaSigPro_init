...
#
#   # Matric Convert
#   sc.p.vector.matrix.2 <- as.matrix(test.scmp.2@scPVector@p.vector)
#   colnames(sc.p.vector.matrix.2) <- "p.value"
#   sc.p.vector.matrix.3 <- as.matrix(test.scmp.3@scPVector@p.vector)
#   colnames(sc.p.vector.matrix.3) <- "p.value"
#   sc.p.vector.matrix.4 <- as.matrix(test.scmp.4@scPVector@p.vector)
#   colnames(sc.p.vector.matrix.4) <- "p.value"
#
#   # Check
#   # Poly-order-2
#   expect_equal(
#     expected = fit2$p.vector,
#     object = sc.p.vector.matrix.2
#   )
#   # Poly-order-3
#   expect_equal(
#     expected = fit3$p.vector,
#     object = sc.p.vector.matrix.3
#   )
#   # Poly-order-4
#   expect_equal(
#     expected = fit4$p.vector,
#     object = sc.p.vector.matrix.4
#   )
# })
